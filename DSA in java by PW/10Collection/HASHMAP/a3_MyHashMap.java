...
public class a3_MyHashMap {
    static class MyHashMap<K,V>{
        ...
        //Traverse the linkedList and loocks for a node with key, if found it returns it's index otherwise it returns null
        ...
        public int size(){ // return thr number of entries in map
            return n;
        }
        public void put(K key,V value){ //insert / update
            int bi = HashFunc(key);  //buckey index
